...
global.owner = process.env.OWNER_NUMBER  || '2349137924240' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=DEkTnK4T#uJ-6-mPlL6l1GL78dBbajosPR9SL3yxLzMrOkIGVdNs' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "2348123999085,2349157709672" : process.env.MODERATORS ,    
